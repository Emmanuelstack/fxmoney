...
def generateAccountNumber()->str : 
    account_number = f'25{randint(10000000,99999999)}'
...
class Customer(models.Model):
    ...
    account_number = models.CharField(max_length=10,blank=False,unique=True,default=generateAccountNumber, editable=False)
...
class Transaction(models.Model):
    sender = models.ForeignKey(to=Customer, on_delete=models.CASCADE, related_name='sent_transactions')
    receiver = models.ForeignKey(to=Customer, on_delete=models.CASCADE, related_name='received_transactions')
